...
In this method, one considers a discrete-time dynamical system defined on a `nice' space (a smooth manifold)\ednote{B: Where can I find a citation for this?} that can be obtained as time-$K$ map of a continuous time-dynamical system, concepts which are formalised below.
...
\ednote{It was suggested that I define these two concepts before stating the theorem.}
\begin{Definition}
...
This requirement is not overly restrictive, as a great number of chaotic systems do have a surjective map. \textbf{(Cite)} \ednote{B: I remember you saying this in one of our sessions, but don't have a source. Could you point me to a resource?}
